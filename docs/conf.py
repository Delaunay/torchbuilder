#!/usr/bin/env python
"""
torchbuilder documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "torchbuilder"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import torchbuilder.core as core  # noqa
...
project = "torchbuilder"
_full_version = core.__version__
...
htmlhelp_basename = "torchbuilder-doc"
